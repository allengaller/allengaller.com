      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="http://allengaller.com/index_cn.html">首页</a></li>
            <li><a href="http://allengaller.com/studio.html">私人工坊</a></li>
            <li><a href="http://allengaller.com">开源项目</a></li>
...
<div id="cli_dialog"></div></body></html>
 ...
 <div class="row">
            ...
            <div class="col-xs-6 col-lg-4">
              ...
              <p><a target="_new" class="btn btn-default" href="http://www.zenxapp.com" role="button">View Website »</a></p>
            </div><!--/span-->
            <div class="col-xs-6 col-lg-4">
              <h2>Galler Media</h2>
